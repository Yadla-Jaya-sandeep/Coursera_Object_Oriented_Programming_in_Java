...
public class AutoCompleteDictionaryTrieTester {
	...
	{
		/*
		assertEquals("Testing add dag on empty: Hello", false, emptyDict.isWord("dog"));
		emptyDict.printTree();
		System.out.println("========");
		emptyDict.addWord("dog");
		emptyDict.printTree();		
		assertEquals("Testing add dag on empty: Hello", true, emptyDict.isWord("dog"));
		*/
